...
The digits 597361, say, are bland and not memorable by themselves. But if you were chased down the street by an alpaca wielding a machete, you would remember it for the rest of your life. Using a well-known code, *alpaca and machete* translates to 597361. So a memory competitor, memorising the number 597361, could imagine an alpaca wielding a machete. This feels strange at first, but quickly becomes easy.
...
At this point there is an obvious objection: What is the point of memorising chess moves? Isn't it enough to understand the plans? I will discuss this thoroughly in [Chapter 8](/chessmemorypalace/chapter8), but for now I will simply ask: Would it help to have your entire opening repertoire written down on paper and placed in front of you at the board? If yes, *The Chess Memory Palace* will help you, because that is what you can achieve in your mind.

To get started, all you need are [Chapters 1–3](/chessmemorypalace/chapter1). [Chapter 1](/chessmemorypalace/chapter1) introduces *Image Notation*, a system for writing chess moves as pictures. “An alpaca wielding a machete” translates to *Be7 Bc6*. After reading [Chapter 1](/chessmemorypalace/chapter1), you will be able to understand Image Notation and play the moves correctly at the board. [Chapter 2](/chessmemorypalace/chapter2) is a crash course on memory techniques: how do you memorise an image so that you never forget it? Then in [Chapter 3](/chessmemorypalace/chapter3) we will become architects, learning to design a memory palace and select the best pictures to put in it.

After reading [Chapters 1–3](/chessmemorypalace/chapter1) you will have all the tools you need to create your own memory palaces and learn your opening repertoire. [Chapter 4](/chessmemorypalace/chapter4) and [Chapter 5](/chessmemorypalace/chapter5) are two example repertoires: one as White against the Ruy Lopez Schliemann, and one as Black against the Ruy Lopez Exchange. “An alpaca wielding a machete” features in the Schliemann memory palace, where it means *7...Be7* and *8.Bxc6*.

If you want to learn either of these openings, you are in luck: you can memorise the palaces and use them in a game! If you don't play these openings, treat them as worked examples to follow when memorising your own repertoire.
...
[Chapter 7](/chessmemorypalace/chapter7) contains my thoughts on creating mnemonic systems and explains the design choices behind the Chess Memory Palace.

[Chapter 8](/chessmemorypalace/chapter8) contains odds and ends, including how to use *spaced repetition* to keep your memories sharp for the long term, and an essay on why it is not sufficient to “understand your openings”, you also need to memorise the moves.

Finally, the [Appendix](/chessmemorypalace/appendix) lists *picture words* for all 384 possible moves. Use it as a reference when building your memory palaces.
...
So what do all these images mean? Let's find out in [Chapter 1](/chessmemorypalace/chapter1).
